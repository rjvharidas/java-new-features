...
public class RecordUsage {
    public static void main(String[] args) {
        ...
        peoples.addAll(getEmployees());
        peoples.addAll(getPersons());

        for(Object obj : peoples){
            switch (obj){
                case Employee employee -> System.out.println("Employee name:" + employee.name());
                case Person persons -> System.out.println("Person name:" + persons.name());
                default -> throw new IllegalStateException("Unexpected value: " + obj);
            }

//            System.out.println(obj.toString());
//            if (obj instanceof Person e ){
